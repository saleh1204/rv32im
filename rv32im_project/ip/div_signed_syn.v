...
//lpm_divide DEVICE_FAMILY="Cyclone IV E" LPM_DREPRESENTATION="SIGNED" LPM_NREPRESENTATION="SIGNED" LPM_PIPELINE=11 LPM_REMAINDERPOSITIVE="TRUE" LPM_WIDTHD=32 LPM_WIDTHN=32 MAXIMIZE_SPEED=6 aclr clock denom numer quotient remain
...
//sign_div_unsign DEN_REPRESENTATION="SIGNED" DEN_WIDTH=32 LPM_PIPELINE=11 MAXIMIZE_SPEED=6 NUM_REPRESENTATION="SIGNED" NUM_WIDTH=32 SKIP_BITS=0 aclr clock denominator numerator quotient remainder
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:09:SJ cbx_lpm_abs 2018:09:12:13:04:09:SJ cbx_lpm_add_sub 2018:09:12:13:04:09:SJ cbx_lpm_divide 2018:09:12:13:04:09:SJ cbx_mgl 2018:09:12:14:15:07:SJ cbx_nadder 2018:09:12:13:04:09:SJ cbx_stratix 2018:09:12:13:04:09:SJ cbx_stratixii 2018:09:12:13:04:09:SJ cbx_util_mgl 2018:09:12:13:04:09:SJ  VERSION_END


//alt_u_div DEVICE_FAMILY="Cyclone IV E" LPM_PIPELINE=11 MAXIMIZE_SPEED=6 SKIP_BITS=0 WIDTH_D=32 WIDTH_N=32 WIDTH_Q=32 WIDTH_R=32 aclr clock den_out denominator numerator quotient remainder
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:09:SJ cbx_lpm_abs 2018:09:12:13:04:09:SJ cbx_lpm_add_sub 2018:09:12:13:04:09:SJ cbx_lpm_divide 2018:09:12:13:04:09:SJ cbx_mgl 2018:09:12:14:15:07:SJ cbx_nadder 2018:09:12:13:04:09:SJ cbx_stratix 2018:09:12:13:04:09:SJ cbx_stratixii 2018:09:12:13:04:09:SJ cbx_util_mgl 2018:09:12:13:04:09:SJ  VERSION_END
...
//synthesis_resources = lut 555 reg 1408 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
`endif
	...
	wire	[351:0]	wire_DFFDenominator_d;
	reg	[351:0]	DFFDenominator;
	reg	[351:0]	DFFNumerator;
	wire	[351:0]	wire_DFFQuotient_d;
	reg	[351:0]	DFFQuotient;
	reg	[351:0]	DFFStage;
	...
	assign
		wire_DFFDenominator_d = {DFFDenominator[319:0], denominator};
	// synopsys translate_off
	initial
		DFFNumerator = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) DFFNumerator <= 352'b0;
		else if  (clk_en == 1'b1)   DFFNumerator <= {DFFNumerator[319:0], numerator};
	// synopsys translate_off
	initial
	...
	// synopsys translate_off
	initial
		DFFQuotient[270:270] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) DFFQuotient[270:270] <= 1'b0;
		else if  (clk_en == 1'b1)   DFFQuotient[270:270] <= wire_DFFQuotient_d[270:270];
	// synopsys translate_off
	initial
		DFFQuotient[271:271] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) DFFQuotient[271:271] <= 1'b0;
	...
	assign
		wire_DFFQuotient_d = {DFFQuotient[319:292], (~ selnose[924]), (~ selnose[957]), (~ selnose[990]), vcc_wire, DFFQuotient[287:263], (~ selnose[825]), (~ selnose[858]), (~ selnose[891]), {4{vcc_wire}}, DFFQuotient[255:234], (~ selnose[726]), (~ selnose[759]), (~ selnose[792]), {7{vcc_wire}}, DFFQuotient[223:205], (~ selnose[627]), (~ selnose[660]), (~ selnose[693]), {10{vcc_wire}}, DFFQuotient[191:176], (~ selnose[528]), (~ selnose[561]), (~ selnose[594]), {13{vcc_wire}}, DFFQuotient[159:146], (~ selnose[462]), (~ selnose[495]), {16{vcc_wire}}, DFFQuotient[127:117], (~ selnose[363]), (~ selnose[396]), (~ selnose[429]), {18{vcc_wire}}, DFFQuotient[95:88], (~ selnose[264]), (~ selnose[297]), (~ selnose[330]), {21{vcc_wire}}, DFFQuotient[63:59], (~ selnose[165]), (~ selnose[198]), (~ selnose[231]), {24{vcc_wire}}, DFFQuotient[31:30], (~ selnose[66]), (~ selnose[99]), (~ selnose[132]), {27{vcc_wire}}, (~ selnose[0]), (~ selnose[33]), {30{vcc_wire}}};
	// synopsys translate_off
	initial
		DFFStage = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) DFFStage <= 352'b0;
		else if  (clk_en == 1'b1)   DFFStage <= {StageOut[991:960], StageOut[895:864], StageOut[799:768], StageOut[703:672], StageOut[607:576], StageOut[511:480], StageOut[447:416], StageOut[351:320], StageOut[255:224], StageOut[159:128], StageOut[63:32]};
	div_signed_add_sub   add_sub_0
	( 
	.cout(wire_add_sub_0_cout),
	.dataa(NumeratorIn[31]),
	.datab(DenominatorIn[0]),
	.result(wire_add_sub_0_result));
	div_signed_add_sub1   add_sub_1
	( 
	...
	assign
		clk_en = 1'b1,
		den_out = DFFDenominator[351:320],
		DenominatorIn = DenominatorIn_tmp,
		DenominatorIn_tmp = {DenominatorIn[1055:1023], {gnd_wire, DFFDenominator[351:320]}, DenominatorIn[989:924], {gnd_wire, DFFDenominator[319:288]}, DenominatorIn[890:825], {gnd_wire, DFFDenominator[287:256]}, DenominatorIn[791:726], {gnd_wire, DFFDenominator[255:224]}, DenominatorIn[692:627], {gnd_wire, DFFDenominator[223:192]}, DenominatorIn[593:528], {gnd_wire, DFFDenominator[191:160]}, DenominatorIn[494:462], {gnd_wire, DFFDenominator[159:128]}, DenominatorIn[428:363], {gnd_wire, DFFDenominator[127:96]}, DenominatorIn[329:264], {gnd_wire, DFFDenominator[95:64]}, DenominatorIn[230:165], {gnd_wire, DFFDenominator[63:32]}, DenominatorIn[131:66], {gnd_wire, DFFDenominator[31:0]}, DenominatorIn[32:0], {gnd_wire, denominator}},
		gnd_wire = 1'b0,
		...
		NumeratorIn_tmp = {NumeratorIn[1023:992], DFFNumerator[351:320], NumeratorIn[959:896], DFFNumerator[319:288], NumeratorIn[863:800], DFFNumerator[287:256], NumeratorIn[767:704], DFFNumerator[255:224], NumeratorIn[671:608], DFFNumerator[223:192], NumeratorIn[575:512], DFFNumerator[191:160], NumeratorIn[479:448], DFFNumerator[159:128], NumeratorIn[415:352], DFFNumerator[127:96], NumeratorIn[319:256], DFFNumerator[95:64], NumeratorIn[223:160], DFFNumerator[63:32], NumeratorIn[127:64], DFFNumerator[31:0], NumeratorIn[31:0], numerator},
		...
		quotient_tmp = {DFFQuotient[351:321], (~ selnose[1023])},
...
(~ nose[253]) | sel[253]), ((~ nose[252]) | sel[252]), ((~ nose[251]) | sel[251]), ((~ nose[250]) | sel[250]), ((~ nose[249]) | sel[249]), ((~ nose[248]) | sel[248]), ((~ nose[247]) | sel[247]), ((~ nose[246]) | sel[246]), ((~ nose[245]) | sel[245]), ((~ nose[244]) | sel[244]), ((~ nose[243]) | sel[243]), ((~ nose[242]) | sel[242]), ((~ nose[241]) | sel[241]), ((~ nose[240]) | sel[240]), ((~ nose[239]) | sel[239]), ((~ nose[238]) | sel
...
(~ selnose[429])}})), (({StageIn[414:384], NumeratorIn[403]} & {32{selnose[396]}}) | (prestg[415:384] & {32{(~ selnose[396])}})), (({StageIn[382:352], NumeratorIn[372]} & {32{selnose[363]}}) | (prestg[383:352] & {32{(~ selnose[363])}})), (({StageIn[350:320], NumeratorIn[341]} & {32{selnose[330]}}) | (prestg[351:320] & {32{(~ selnose[330])}})), (({StageIn[318:288], NumeratorIn[310]} & {32{selnose[297]}}) | (prestg[319:288] & {32{(~ selnose[297])}})), (({StageIn[286:256], NumeratorIn[279]} & {32{selnose[264]}}) | (prestg[287:256] & {32{(~ selnose[264])}})), (({StageIn[254:224], NumeratorIn[248]} & {32{selnose[231]}}) | (prestg[255:224] & {32{(~ selnose[231])}})), (({StageIn[222:192], NumeratorIn[217]} & {32{selnose[198]}}) | (prestg[223:192] & {32{(~ selnose[198])}})), (({StageIn[190:160], NumeratorIn[186]} & {32{selnose[165]}}) | (prestg[191:160] & {32{(~ selnose[165])}})), (({StageIn[158:128], NumeratorIn[155]} & {32{selnose[132]}}) | (prestg[159:128] & {32{(~ selnose[132])}})), (({StageIn[126:96], NumeratorIn[124]} & {32{selnose[99]}}) | (prestg[127:96] & {32{(~ selnose[99])}})), (({StageIn[94:64], NumeratorIn[93]} & {32{selnose[66]}}) | (prestg[95:64] & {32{(~ selnose[66])}})), (({StageIn[62:32], NumeratorIn[62]} & {32{selnose[33]}}) | (prestg[63:32] & {32{(~ selnose[33])}})), (({StageIn[30:0], NumeratorIn[31]} & {32{selnose[0]}}) | (prestg[31:0] & {32{(~ selnose[0])}}))},
		vcc_wire = 1'b1;
endmodule //div_signed_alt_u_div


//lpm_add_sub DEVICE_FAMILY="Cyclone IV E" LPM_DIRECTION="SUB" LPM_WIDTH=32 cin dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:09:SJ cbx_lpm_add_sub 2018:09:12:13:04:09:SJ cbx_mgl 2018:09:12:14:15:07:SJ cbx_nadder 2018:09:12:13:04:09:SJ cbx_stratix 2018:09:12:13:04:09:SJ cbx_stratixii 2018:09:12:13:04:09:SJ  VERSION_END
...
//synthesis_resources = lut 652 reg 1430 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_signed_sign_div_unsign
	( 
	aclr,
	clock,
	denominator,
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   DFF_Num_Sign10 <= num_choice[31];
	// synopsys translate_off
	initial
		DFF_q_is_neg0 = 0;
	// synopsys translate_on
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   DFF_q_is_neg10 <= q_is_neg;
	assign
	...
	assign
		...
		zero_wire = {32{1'b0}},
		zero_wire_2 = {32{1'b0}};
endmodule //div_signed_sign_div_unsign

//synthesis_resources = lut 652 reg 1430 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  div_signed_lpm_divide
	( 
	aclr,
	clock,
	denom,
...
`endif
	...
	div_signed_sign_div_unsign   divider
	( 
	.aclr(aclr),
	.clock(clock),
	.denominator(denom),
...
endmodule //div_signed_lpm_divide
//VALID FILE
...
module div_signed (
	...
	div_signed_lpm_divide	div_signed_lpm_divide_component (
				.aclr (aclr),
				.clock (clock),
				.denom (denom),
				.numer (numer),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL div_signed.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL div_signed.inc TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL div_signed.cmp TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL div_signed.bsf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL div_signed_inst.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL div_signed_bb.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL div_signed_syn.v TRUE
